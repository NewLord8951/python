...
Запоминающим элементом динамических ЗУ служит конденсатор. Информация хранится в форме наличия или отсутствия его заряда.17. Кэш-память создана для уменьшения задержек, связанных с доступом к данным из оперативной памяти. Она представляет собой небольшой объём быстрой памяти, расположенной непосредственно рядом с процессором.
